...
const sensorsTeams = [
  ...
  },
  {
    ...
    data: () => ({
      ...
      body_temperature: parseFloat((36.6 + (Math.random() - 0.5) * 0.5).toFixed(1)),
    }),
  },
],
  },
  ...
  },
  {
    ...
    data: () => ({
      ...
      body_temperature: parseFloat((37.0 + (Math.random() - 0.5) * 0.5).toFixed(1)),
    }),
  },
],
  },
  ...
  },
  {
    ...
    data: () => ({
      ...
      body_temperature: parseFloat((37.5 + (Math.random() - 0.5) * 0.5).toFixed(1)),
    }),
  },
    ],
  },
